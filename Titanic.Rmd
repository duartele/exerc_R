...
Por fim, qual é a associação entre **parch** e **sibsp**?
...
Durante a Análise Descritiva, percebemos que algumas variáveis pareciam ajudar a explicar o comportamento da variável resposta. Nesta seção, verificaremos se as diferenças acima encontradas são significativas (ou não) usando técnicas inferenciais.
...
p^ = S/n ~ N(p,p(1-p)/n), em que S = quantidade de sobreviventes na amostra e n é o tamanho da amostra.

Logo, p^ = 500/1309 = 0,381971 (Estimativa Pontual)
