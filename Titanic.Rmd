...
Antes de aplicarmos os modelos, precisamos fazer alguns pré-processamentos, como criar labels para as variáveis categóricas, tratar os valores faltantes e dividir a amostra em treino e teste (já mencionado).

**age, fare, embarked, faixa_etária: factor,**

Para fazer essa divisão, poderíamos usar um pacote (por exemplo, "caTools"). Porém, podemos simplesmente gerar números aleatórios, conforme se verifica abaixo:
