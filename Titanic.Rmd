...
No tocante à Inferência Estatística, construímos o intervalo [0.3556502;0.4082917] com grau de confiança de 95% para a proporção de passageiros sobreviventes. Considerando que este intervalo não contém  os valores informados no site da Wikipédia (os valores lá apresentados estão entre [0,2648;0,3525]), podemos afirmar que a proporção de sobreviência é maior que a informada no site. As possíveis causas para isto ter ocorrido é que os tripulantes tiveram menos chance de sobrevivência, o que diminuiu a proporção de sobreviventes total (nossa base só tem informações dos passageiros). Outra possibilidade é que os poucos passageiros que não fizem parte da amostra também fizeram com que a porporção de sobreviventes diminuísse.
