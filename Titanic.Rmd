...
#attach(df) #Como só usaremos esse data frame, é seguro usar o attach
```
...
Pela apreciação do gráfico, percebe-se que as mulheres tiveram mais chances de sobrevivência que os homens, indicando assim que a variável sexo pode ajudar a explicar a sobrevivência de um passageiro.
...
A maioria dos passageiros possuía embarcou sozinho ou com um(a) espos(a)(ou irmã(o)). Talvez podemos categorizar essa variável em "possui" ou "não possui" irmãos ou esposos.